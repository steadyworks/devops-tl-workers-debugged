...
# TEST_DATABASE_URL is unset. Point at the same cluster via psycopg3
# async driver (asyncpg isn't in requirements.txt). Set before pytest
# descends into backend/tests/ so nested conftests see it.
os.environ.setdefault(
    "TEST_DATABASE_URL",
    "postgresql+psycopg://photobook:photobook@localhost:5432/photobook",
)
